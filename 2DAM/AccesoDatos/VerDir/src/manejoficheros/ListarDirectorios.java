...
public class ListarDirectorios {
    ...
    public static void main(String[] args) {
        ...
        //Le pasamos una ruta y una opcion (1,2,3)
    ...
    public static void verDirectorioColumna(File f) {
        ...
        //Bucle para darle una medida a las columnas
        for (int i = 0; i < mostrar.length; i++) {
            for (int j = 0; j < mostrar[0].length; j++) {
                if (mostrar[i][j].length() <= 35) {
                    while(mostrar[i][j].length() <= 35){
                        mostrar[i][j] = mostrar[i][j] + " ";
                    }
                }
            }
        }
