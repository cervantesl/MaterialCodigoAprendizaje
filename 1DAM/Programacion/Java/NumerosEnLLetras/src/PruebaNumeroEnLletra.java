...
public class PruebaNumeroEnLletra{
    ...
    static String noudigitsEnLletres(int q9){
       ...
       if(digitCentenaMillo+digitDecenaMillo+digitUnitatMillo != 0){
           millons = tresDigitsEnLletres(digitCentenaMillo+digitDecenaMillo+digitUnitatMillo)+" milions "; 
       }
       if(digitCentenaMillo+digitDecenaMillo+digitUnitatMillo == 1){
           millons = tresDigitsEnLletres(digitCentenaMillo+digitDecenaMillo+digitUnitatMillo)+" milio "; 
       }
